...
generic dynamic-object collision rules live in
...
[`scripts/frames_and_grasping.py`](https://github.com/isaac-sim/IsaacSim/blob/7c206f75bdadd9e05fc457f19863ca4c3f0cb693/skills/motion-generation/scripts/frames_and_grasping.py) to calibrate it.

Convert task-space contact targets to cuMotion tool targets:

Use `tool_target_from_contact_target` in
[`scripts/frames_and_grasping.py`](https://github.com/isaac-sim/IsaacSim/blob/7c206f75bdadd9e05fc457f19863ca4c3f0cb693/skills/motion-generation/scripts/frames_and_grasping.py) to convert the
